    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50/30 flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-400 text-sm mb-8">Após confirmar, faça login para ativar seu período de teste.</p>
          <Link
            href="/admin/login"
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50/30 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">3 dias grátis, sem precisar de cartão</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <button type="button" onClick={handleGoogleSignUp} disabled={loadingGoogle}
        ...
        <div className="text-center mt-6">
          <Link href="/admin/login" className="text-[#6B1C3A] hover:text-[#9B2D5E] text-sm font-medium transition-colors">
            Já tem conta? Entrar
          </Link>
        </div>
      </div>
