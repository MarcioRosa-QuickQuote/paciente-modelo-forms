    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-rose-50/30 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          <Image src="/logo.png" alt="Logo" width={72} height={72} className="rounded-2xl shadow-lg shadow-[#6B1C3A]/20 mb-4" />
          <h1 className="text-2xl font-bold text-gray-900">Formulário de Conversão</h1>
        ...
        <div className="text-center mt-6">
          <Link href="/admin/ativar" className="text-[#6B1C3A] hover:text-[#9B2D5E] text-sm font-medium transition-colors">
