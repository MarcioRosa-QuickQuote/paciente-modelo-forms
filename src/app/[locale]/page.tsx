...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#080010] text-white min-h-screen overflow-x-hidden">
      ...
      {/* ── Hero ── */}
      <section className="pt-20 pb-8 lg:pt-24 lg:pb-16 px-6 relative overflow-hidden">
        {/* Glow background */}
        ...
        <div className="relative max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-6 lg:gap-16">
          ...
          <div className="flex-1 flex flex-col items-start text-left">
            ...
            <motion.div
              ...
              className="hidden lg:inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-violet-500/30 bg-violet-500/10 text-violet-300 text-sm font-medium mb-7"
            >
