...
export default function StepFee({ feeAmount, onYes, onNo }: Props) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[100dvh] px-6 py-8">
      ...
      <motion.div
        ...
        className="w-20 h-20 bg-gradient-to-br from-emerald-500 to-teal-400 rounded-full flex items-center justify-center mb-8 shadow-lg shadow-emerald-500/30"
      >
      ...
      >
        <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-full">
          ...
          <span className="text-emerald-700 text-xs font-medium">Valor abatido</span>
        </div>
        <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 rounded-full">
          <svg className="w-4 h-4 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
          <span className="text-emerald-700 text-xs font-medium">Seguro</span>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="w-full"
      >
        <YesNoButtons onYes={onYes} onNo={onNo} yesText="Sim, concordo!" noText="Não" />
      </motion.div>
    </div>
  );
}
