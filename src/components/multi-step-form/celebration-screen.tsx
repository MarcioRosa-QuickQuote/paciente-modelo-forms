    ...
    <div className="relative flex flex-col items-center justify-center min-h-[100dvh] px-6 py-8 overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-500 text-base leading-relaxed max-w-sm mx-auto">
          ...
          <br />
          É só chamar a gente e aguardar nosso retorno 🥰
        </p>
      </motion.div>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="z-10 inline-flex items-center gap-3 px-8 py-5 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold text-lg rounded-2xl shadow-xl shadow-green-500/30 hover:shadow-2xl hover:shadow-green-500/40 transition-shadow"
      >
