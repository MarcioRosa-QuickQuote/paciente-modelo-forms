          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100">
            {slug && (
              <p className="text-xs text-gray-400">
                /formulario/<span className="text-[#6B1C3A] font-medium">{slug}</span>
              </p>
            )}
            <button
              type="button"
              onClick={() => setConfigModalOpen(true)}
              className="ml-auto p-2 rounded-lg hover:bg-gray-100 text-gray-400 hover:text-[#6B1C3A] transition-colors"
